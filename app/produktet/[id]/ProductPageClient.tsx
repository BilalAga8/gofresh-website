                ...
                <div className="flex items-center w-fit border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (!Number.isNaN(n) && n >= 0.1) setQuantity(n);
                      else if (e.target.value === "") setQuantity(0.5);
                    }}
                    className="w-14 h-11 text-center text-lg font-bold text-gray-900 border-x border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-400"
                  />
                  <button
