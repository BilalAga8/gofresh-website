...
export const metadata: Metadata = {
  title: "Rreth Nesh",
  description:
    "Agro Fresh është një fermë familjare në Tiranë që nga viti 2010. Sjellim produkte bio, natyrale dhe të freskëta direkt tek ju.",
  openGraph: {
    title: "Rreth Nesh | Agro Fresh",
    description:
      "Mëso historinë tonë — fermë familjare që sjell produkte natyrale direkt nga toka tek tryeza juaj.",
...
const vlerat = [
  {
    ...
    title: "100% Natyrale",
    desc: "Asnjë pesticide, asnjë kimikate — vetëm produkte të pastra nga natyra.",
  },
  {
    icon: <FaSeedling className="text-green-500 text-2xl" />,
    title: "Bio & i Qëndrueshëm",
    desc: "Metodat tona të kultivimit respektojnë tokën dhe mjedisin.",
  },
  {
    icon: <FaTruck className="text-green-500 text-2xl" />,
    title: "Dërgesa e Shpejtë",
    desc: "Nga ferma direkt tek dera juaj, sa më të freskëta të jetë e mundur.",
  },
  {
    icon: <FaHeart className="text-green-500 text-2xl" />,
    title: "Me Dashuri",
    desc: "Çdo produkt është kultivuar me kujdes dhe përkushtim nga familja jonë.",
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-green-700 to-green-500 text-white py-20 px-6 text-center">
        ...
        <p className="text-green-100 max-w-2xl mx-auto text-lg">
          Që nga viti 2010, sjellim produkte të freskëta, bio dhe të kultivuara
          me dashuri direkt nga ferma jonë tek tryeza juaj.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Agro Fresh filloi si një fermë e vogël familjare në periferi të
            Tiranës. Me punë të palodhur dhe dashuri për natyrën, sot kemi
            zgjeruar veprimtarinë tonë duke shërbyer qindra familje çdo ditë.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Misioni ynë është i thjeshtë: të sjellim ushqim të shëndetshëm, të
            freskët dhe të sigurt tek çdo familje shqiptare, me çmime të
            arsyeshme.
          </p>
          <Link
            href="/produktet"
      ...
      <section className="bg-gradient-to-br from-green-700 to-green-500 py-16 px-6">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <p className="text-green-100 mb-10">
            Jemi gjithmonë të gatshëm t&apos;ju ndihmojmë.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              {
              ...
              >
                ...
                <p className="text-xs font-semibold uppercase tracking-wide text-green-200 mb-1">
                  {c.label}
                </p>
